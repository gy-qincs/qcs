...
<body>
	...
	<script type="text/javascript">
		...
		window.onload = function() {
			...
			function loadJSAPI() {
				remoteLog.infoLog('tpcarcompletion','openPage');
				...
				if(carSize == '0'){
					...
					$(document).on("optionMenu", function(){
						...
						var path = '../tpitf/myCarList?r=' + Math.random();
						//location.href = path;
	...
	function valiCarInfo() {
		...
		if(carNumb.value == ""){
			...
			if(submit_flag == '0'){
				...
				remoteLog.infoLog('tpcarcompletion','clicked');
				saveHidden();
				setTimeout(function() {
					ajaxSubmit();
				}, 200)
	...
	function ajaxSubmit(){
		$.ajax({
		    type: 'post',
		    url: '../tpitf/addNewCarInfoAjax?r=' + Math.random(),
